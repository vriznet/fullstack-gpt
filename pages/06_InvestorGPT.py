...
agent = initialize_agent(
    ...
    agent_kwargs={
        "system_message": SystemMessage(
            ...
            Consider the performance of a stock, the company overview and

            the income statement.

            Be assertive in your judgement and recommend the stock or

            advise the user against it.
        """
        )
    },
)
...
st.markdown(
    ...
    Write down the name of a company and

    our Agent will do the research for you.
"""
)
...
if company:
    ...
    st.write(result["output"].replace("$", "\$"))  # noqa W605
